...
const securityHeaders = [
  ...
  },
  {
    ...
    value: `default-src 'self'; manifest-src 'self'; worker-src 'self'; frame-src 'self' https://upload-widget.cloudinary.com; script-src 'self' 'unsafe-inline' https://cdnjs.cloudflare.com https://upload-widget.cloudinary.com; style-src 'self' 'unsafe-inline' https://cdnjs.cloudflare.com; media-src 'self' https://res.cloudinary.com ; img-src 'self' data: blob: https://res.cloudinary.com; font-src 'self' 'unsafe-inline' https://cdnjs.cloudflare.com; connect-src 'self' https://res.cloudinary.com https://sentry.io https://*.ingest.sentry.io https://*.sentry.io;`,
  },
];
